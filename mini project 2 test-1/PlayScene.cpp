	...
	for (int i = 0; i < SpeedMult; i++) {
        ...
        for(int j = 0 ; j < std::get<2>(current) ; j++){
            ...
            switch (std::get<0>(current)) {
                ...
                //bonus_1
                case 5:
                    EnemyGroup->AddNewObject(enemy = new GoastEnemy(SpawnCoordinate.x, SpawnCoordinate.y));
					break;
				default:
					continue;
			}
...
void PlayScene::OnMouseUp(int button, int mx, int my) {
	...
	if (button & 1) {
        ...
        if(mapState[y][x] == TILE_OCCUPIED){
            ...
            if(my_flag) mapState[y][x] = TILE_FLOOR;
        }


		if (mapState[y][x] != TILE_OCCUPIED && preview->GetPrice()!=0) {//minitodo4
			if (!preview)
				return;
			// Check if valid.
...
void PlayScene::ConstructUI() {
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
        ...
        , 530, 128*MapHeight, GarbageTurret::Price);
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
        ...
        , 650, 128*MapHeight, AcidophilTurret::Price);
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
        ...
        , 770, 128*MapHeight, BoomTurret::Price);
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
        ...
        , 890, 128*MapHeight, MacrophageTurret::Price);
...
void PlayScene::UIBtnClicked(int id) {
    ...
    //minitodo2
    else if(id==3&&money >= GarbageTurret::Price)
        preview = new GarbageTurret(0, 0);
    //minitodo3
    else if(id==4&&money >= AcidophilTurret::Price)
        preview = new AcidophilTurret(0, 0);
    //minitodo4
    else if(id==5&&money >= BoomTurret::Price)
        preview = new BoomTurret(0, 0);
    //bonus_1
    else if(id==6&&money >= MacrophageTurret::Price)
        preview = new MacrophageTurret(0, 0);
