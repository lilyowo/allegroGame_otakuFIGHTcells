...
void StageSelectScene::Initialize() {
    ...
    btn = new Engine::ImageButton("win/dirt.png", "win/floor.png", w-300 , halfH * 7 / 4 - 150, 130, 50);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::BackOnClick, this, 4));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 20, w-240 , halfH * 7 / 4 - 125, 0, 0, 0, 255, 0.5, 0.5));
}
